...
// Keyset-pagination cursor for GET /admin/media — this module's own copy
...
// adapted copy rather than a shared import).
//
...
export function decodeMediaCursor(raw: string): MediaCursor {
  let parsed: unknown;
  try {
