...
| 9 | Consent token expiry and single-use (R5) | Implemented as proposed (PR #42) — 72h TTL, single-use, resend path. TTL value and overall approach still need review | Counsel |
