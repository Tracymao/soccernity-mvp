...
tools: Read, Write, Edit, Bash, Grep, Glob, Skill, mcp__claude_ai_Figma__get_design_context, mcp__claude_ai_Figma__get_code_connect_suggestions, mcp__claude_ai_Figma__get_variable_defs, mcp__claude_ai_Figma__download_assets
model: sonnet
---
