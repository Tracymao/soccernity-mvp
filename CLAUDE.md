...
- This file has one real Figma variable collection: **`Soccernity Theme`**
  ...
  **Dark** (`5096:1`), **16** COLOR variables (`sprint-2/elevation-overlay-effect-style` added `color/shadow/overlay-ambient` and `color/shadow/overlay-key`, Decision Log #182) — Sprint D created the original
